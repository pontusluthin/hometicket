                        ...
                        <div class="row">
                                <div class="jumbotron">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="id" value="<?php echo $result['customerId'];?>">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="adress" placeholder="Enter address" value="<?php echo $result['adress'];?>">
                                                </div>
                                                <div class="form-group">
                                                        <label for="zip_code">Zip Code</label>
                                                        <input type="number" class="form-control" name="zip_code" placeholder="Enter zip code" value="<?php echo $result['zip_code'];?>">
                                                </div>
                                                <div class="form-group">
                                                        <label for="city">City</label>
                                                        <input type="text" class="form-control" name="city" placeholder="Enter city" value="<?php echo $result['city'];?>">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="phone" placeholder="Enter phone" value="<?php echo $result['phone'];?>">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="password" placeholder="Enter password" value="<?php echo $result['password'];?>">
                                                </div>
