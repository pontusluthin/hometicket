                                ...
                                <div class="jumbotron">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="eventDate" placeholder="Enter Event Date">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="eventInfo" placeholder="Enter Event Info">
                                                </div>
                                                <div class="form-group">
                                                        <label for="eventImg">Event Price</label>
                                                        <input type="number" class="form-control" name="eventPrice" placeholder="Enter Event Price">
                                                </div>
