                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td class="hidetext"><?php echo $row['adminPassword'];?></td>
                                                                <td><?php echo $row['adminEmail'];?></td>
                                                                <td><?php echo $row['adminPhone'];?></td>
                                                                <td><a class="btn btn-sm btn-primary" href="edit.php?id=<?php echo $row['adminId'];?>">Edit</a> &nbsp; <a class="btn btn-sm btn-danger" href="adminDisplay.php?del=<?php echo $row['adminId'];?>">Delete</a></td>
                                                        </tr>
